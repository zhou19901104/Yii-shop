...
$this->registerCssFile('style/list.css', ['depends' => ['frontend\assets\AppAsset']]);
$this->registerCssFile('style/bottomnav.css', ['depends' => ['frontend\assets\AppAsset']]);
$this->registerJsFile('js/list.js', ['depends' => ['frontend\assets\AppAsset']]);
$this->title = '京西商城-搜索结果页';
?>
<?php $this->beginPage() ?>
...
<body>
    ...
    <?= $this->render('/layouts/partials/_topHeadNav', compact('keyword')) ?>
    ...
    <?= $this->render('/layouts/partials/_footerNav') ?>
